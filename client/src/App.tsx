  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/linegraph" element={<Line data={timeSeriesData} width={500} height={500} categoryEncoding={"6"} variableEncoding={"B11"} variableDescription={"What was your total income last year in USD?"} />} />
